...
- ./.github/instructions/css.instructions.md: Guidelines for editing CSS stylesheet files.
- ./.github/instructions/controller.instructions.md: Guidelines for editing controller classes.
- ./.github/instructions/java.instructions.md: Coding standards for Java source files.
- ./.github/instructions/jsp.instructions.md: Guidelines for editing JSP view templates.
- ./.github/instructions/service.instructions.md: Guidelines for editing service classes.
- ./.github/instructions/markdown.instructions.md: Guidelines for editing Markdown files in the project. (This file)
- ./.github/instructions/test.instructions.md: Testing standards for Java test files.
