...
@Primary
@Service(value = "PokemonApiService")
public class PokemonApiService implements PokemonService
{
    /* Logging instance */
    private static final Logger LOGGER = LogManager.getLogger(PokemonApiService.class);
    protected final PokeApiClient pokeApiClient;
    @Qualifier(POKEAPI_JSON_DECODER_BEAN)
     ...
     */
    @Override
    public List<String> getPokemonLocationAreas(String url) throws Exception
    {
    ...
    public List<String> getPokemonLocationAreaEncounters(String url)
    {
        HttpResponse<String> response;
